...
const Statistics = () => {
  ...
  return (
    <section className="relative py-16 lg:py-20 bg-white text-gray-900 overflow-hidden">
          ...
          {[1, 2, 3, 4].map((num, index) => {
            ...
            return (
              <div key={num} className="flex flex-col items-center text-center group">
                ...
                <div className="text-3xl md:text-[2.6rem] font-black tracking-tightest leading-tight mb-1.5 text-gray-900" dir="ltr">
